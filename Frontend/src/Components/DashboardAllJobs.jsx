                ...
                <div className="w-full overflow-x-auto flex gap-6 py-4 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 cursor-pointer">
                    {jobs.map((data, index) => (
                        <div
                            ...
                            className={`min-w-[300px] cursor-pointer  shadow-lg rounded-xl p-6 transition hover:bg-gray-700 ${jobId === data._id ? "bg-[#000000] " : "bg-gray-800  "}`}
                        >
                            <h3 className="text-lg font-semibold text-blue-400 ">{data.jobTitle}</h3>
