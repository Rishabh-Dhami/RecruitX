  ...
  return (
    <div className="w-full lg:min-h-screen mb-16 px-6 sm:px-12 lg:px-20 mt-12 relative lg:pt-20">
      <div className="w-full relative text-center ">
        <h1 className="text-3xl lg:text-6xl font-semibold   lg:text-left">How Its Works</h1>
      ...
      <p className="w-full text-sm mt-10 text-center lg:text-left">
        Explore the following these steps will help you find <br className="hidden md:block"/> a job easily
      </p>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-14">
        ...
        <div className="w-full bg-[#333333] rounded-lg py-8 px-6 md:px-10 flex justify-between items-center">
          ...
          <div className="text-9xl font-text-6xl md:text-9xl font-extrabold">2</div>
        </div>
        <div className="w-full bg-[#333333] rounded-lg py-8 px-6 md:px-10 flex justify-between items-center">
          <div>
            <p className="font-bold bg-[#49A0CB] h-16 w-16 flex justify-center items-center text-3xl rounded-full ">
          ...
          <div className="text-9xl font-text-6xl md:text-9xl font-extrabold">3</div>
        </div>
      </div>
    </div>
  );
