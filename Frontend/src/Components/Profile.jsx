...
function Profile() {
  ...
  return (
    <div className='w-full h-full relative'>
        ...
        <p className='border-2 py-1 px-2 rounded-md  hover:bg-gray-700 text-sm border-gray-50 absolute right-0 top-1 cursor-pointer' onClick={() => (navigate("/edit-profile"))}>Edit Profile</p>
        <div className='mt-6 leading-10'>
            ...
            <div className='flex justify-start items-center  border-b-2 border-gray-50 mb-5 pb-2'>
              ...
              <div className='w-12 h-12 rounded-full'>
                <img className='w-full h-full rounded-full object-cover' src={userData?.avatar} alt="" srcset="" />
               </div>
            </div>
        </div>
    </div>
