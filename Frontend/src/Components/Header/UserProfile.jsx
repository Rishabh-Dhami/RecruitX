...
function UserProfile({setMenuOpen}) {
  ...
  return (
    <div className="">
      ...
      >
        <img src={userData?.avatar} className="w-full h-full rounded-full object-cover object-top border-gray-100 border-2" alt="" />
      </button>
      ...
      {open && (
        <div className="absolute h-screen top-0 right-0 mt-2 w-80 cursor-pointer bg-[#191B1F] shadow-md rounded-lg">
            <div className="w-full  p-4 shadow-sm shadow-white">
                ...
                <p className="w-12 h-12"><img src={userData?.avatar} className="w-full h-full rounded-full object-cover object-top border-gray-100 border-2" alt="" /></p>
                <div className="pl-3">
                    <h1 className="">{userData?.fullname}</h1>
                    <h3 className="text-xs">{userData?.email}</h3>                   
                </div>
                </div>
                <p className="text-xs p-1 rounded-lg bg-gray-600 inline-block ml-14 mt-2">{userData?.role}</p>
                <i onClick={
                    () => {setOpen(!open)}
                } className=" absolute right-0 top-0 ri-close-line text-xl hover:bg-gray-700 cursor-pointer p-1 rounded-sm"></i>
            </div>
          ...
          <ul className="py-2">
            ...
            <li className="px-7 py-2 hover:bg-gray-600 cursor-pointer"><i className="text-sm pr-2 ri-book-open-line"></i>Help guide</li>
          </ul>
